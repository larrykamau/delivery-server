# Generated by Django 3.0.5 on 2020-04-29 09:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', kda.account.models.PossiblePhoneNumberField(blank=True, default='254777777777', max_length=128, region=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', kda.account.models.PossiblePhoneNumberField(blank=True, default='', max_length=128, region=None)),
            ],
            options={
                'ordering': ('pk',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('private_metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, encoder=kda.core.utils.json_serializer.CustomJsonEncoder, null=True)),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, encoder=kda.core.utils.json_serializer.CustomJsonEncoder, null=True)),
                ('type', models.CharField(choices=[('Two Wheel Vehicle', 'Two Wheel Vehicle'), ('Three Wheel Vehicle', 'Three Wheel Vehicle'), ('Four Wheel Vehicle', 'Four Wheel Vehicle')], default='Two Wheel Vehicle', max_length=50)),
                ('country_origin', models.CharField(blank=True, max_length=256)),
                ('number_plate', models.CharField(blank=True, max_length=256)),
                ('liscence_number', models.CharField(blank=True, max_length=256)),
                ('inspected', models.BooleanField(default=False)),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vehicle_info', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liscence_id', models.CharField(blank=True, max_length=256)),
                ('is_active', models.BooleanField(default=True)),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rider_info', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('pk', 'name'),
            },
