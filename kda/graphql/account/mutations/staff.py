...
class CustomerUpdate(CustomerCreate):
    ...
    @classmethod
    def generate_events(
        cls, info, old_instance: models.CustomUser, new_instance: models.CustomUser
    ):
...
class StaffCreate(ModelMutation):
    ...
    @classmethod
    def clean_groups(cls, requestor: models.CustomUser, cleaned_input: dict, errors: dict):
    ...
    def ensure_requestor_can_manage_groups(
        cls, requestor: models.CustomUser, cleaned_input: dict, field: str, errors: dict
    ):
...
class StaffUpdate(StaffCreate):
    ...
    def check_if_deactivating_superuser_or_own_account(
        cls, instance: models.CustomUser, requestor: models.CustomUser, errors: dict
    ):
    ...
    def check_if_deactivating_left_not_manageable_permissions(
        cls, user: models.CustomUser, requestor: models.CustomUser, errors: dict
    ):
